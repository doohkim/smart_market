    ...
    class Meta:
        ...
        widgets = {
            'username': forms.TextInput(
                attrs={'class': 'form-control', 'placeholder': 'UserName 입력해주세요'}),
            'email': forms.EmailInput(
                attrs={'class': 'form-control', 'placeholder': 'Email 입력해주세요'}),
            'password': forms.PasswordInput(
                attrs={'class': 'form-control', 'placeholder': 'Password 입력해주세요'}),
        }
        labels = {
            'username': '닉네임',
            'email': '이메일',
